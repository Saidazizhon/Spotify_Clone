...
function Home() {
  ...
  useEffect(() => {
    if(token){
      spotifyApi.searchAlbums("Shaxriyor").then(res => {
    ...
    <Suspense fallback={<img className='absolute inset-0 m-auto' src={Laoding} alt='loading img' width={120} height={120} />} >
      ...
      <div className='p-5'>
        ...
        <div className="space-y-[50px]">
          <MusicItem artistName={"Bojalar "} />
          <MusicItem artistName={"Shaxriyor "} />
          <MusicItem artistName={"Shoxrux "} />
          <MusicItem artistName={"Munisa Rizaeva "} />
          <MusicItem artistName={"Lola "} />
        </div>
