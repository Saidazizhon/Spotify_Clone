    ...
    <div className='single-bg h-[100vh] overflow-y-auto p-5 pb-[100px]'>
      ...
      <div className="flex items-end mx-auto pt-[30px] gap-[32px] w-[95%] p-2">
        ...
        <div className="">
          ...
          <span className='font-medium text-[20px] text-white block'> <p className='text-[#C2C3B9] inline-block'>Made for</p> MOhirjon . {trackInfo.totalTrack} songs, {trackInfo.time} min </span>
        </div>
      </div>
